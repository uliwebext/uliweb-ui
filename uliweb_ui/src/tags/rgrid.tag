<rgrid>
  ...
  <query-condition rules={query_rules} fields={query_fields} layout={query_layout}></query-condition>
  <rtable cols={cols} options={rtable_options} data={data}></rtable>
  <div class="clearfix tools">
    <pagination if={pagination} data={data} url={url} page={page} total={total}></pagination>
   ...
   * opts = {cols:,
     ...
     pagination:true,
     tableClass:, nameField:, labelField:, page:, total:}
   */
  self = this
