...
riot.tag2('pagination', '<ul if="{theme==\'long\'}" class="pagination"> <li if="{totalMessage}" class="disabled total"><a>{totalMessage}</a></li> <li if="{has_first}" class="first"><a href="#" onclick="{go(1)}"><pagination-raw content="{first}"></pagination-raw></a></li> <li if="{has_prev}" class="prev"><a href="#" onclick="{go(page-1)}"><pagination-raw content="{prev}"></pagination-raw></a></li> <li class="{page:true, active:p==page}" each="{p in pages}"><a href="#" onclick="{go(p)}">{p}</a></li> <li if="{has_next}" class="next"><a href="#" onclick="{go(page+1)}"><pagination-raw content="{next}"></pagination-raw></a></li> <li if="{has_last}" class="last"><a href="#" onclick="{go(totalPages)}"><pagination-raw content="{last}"></pagination-raw></a></li> <li if="{refresh}" class="refresh"><a href="#" onclick="{go(page)}"><pagination-raw content="{refresh}"></pagination-raw></a></li> </ul> <div if="{theme==\'long\' && buttons.length>0}" class="pull-right {btn_group_class}"> <button each="{btn in buttons}" data-is="pagination-button" btn="{btn}"></button> </div> <div if="{theme==\'simple\'}" class="{btn_group_class} pull-left pagination"> <a class="btn btn-default" __disabled="{totalPages<=1 || page==1}" onclick="{go(1)}" title="{first_title}"><pagination-raw content="{first}"></pagination-raw></a> <a class="btn btn-default" __disabled="{!has_prev}" onclick="{go(page-1)}" title="{prev_title}"><pagination-raw content="{prev}"></pagination-raw></a> <a class="btn btn-default page_input">第 <input type="text" onkeyup="{page_input_click}" value="{page}" style="width:40px"> 页/共{totalPages}页</input></a> <a class="btn btn-default" __disabled="{!has_next}" onclick="{go(page+1)}" title="{next_title}"><pagination-raw content="{next}"></pagination-raw></a> <a class="btn btn-default" __disabled="{totalPages<=1 || page==totalPages}" onclick="{go(totalPages)}" title="{last_title}"><pagination-raw content="{last}"></pagination-raw></a> <a if="{refresh}" class="btn btn-default" onclick="{go(page)}" title="{refresh_title}"><pagination-raw content="{refresh}"></pagination-raw></a> </div> <div if="{theme==\'simple\' && buttons.length>0}" class="pull-left {btn_group_class}"> <button each="{btn in buttons}" data-is="pagination-button" btn="{btn}"></button> </div> <p if="{theme==\'simple\'}" class="pull-right message">{totalMessage}</p>', 'pagination .pagination,[riot-tag="pagination"] .pagination,[data-is="pagination"] .pagination{margin-right:5px;} pagination .pagination>li.disabled>a,[riot-tag="pagination"] .pagination>li.disabled>a,[data-is="pagination"] .pagination>li.disabled>a{color:#999;} pagination .page_input,[riot-tag="pagination"] .page_input,[data-is="pagination"] .page_input{padding:0px 12px; line-height: 34px; height:34px;} pagination .page_input input,[riot-tag="pagination"] .page_input input,[data-is="pagination"] .page_input input{height:20px;line-height:20px;margin:0;} pagination .message,[riot-tag="pagination"] .message,[data-is="pagination"] .message{line-height: 34px;line:34px;margin:0 auto;} pagination .btn.disabled,[riot-tag="pagination"] .btn.disabled,[data-is="pagination"] .btn.disabled{cursor:not-allowed;}', '', function(opts) {
